...
/*
 * Creates a new token with a value of the specified size
 *
 * Parameters:
 *  type    The type of the token to create
 *  value   The pointer to the value for TOK_WORD and TOK_QUOTED_WORD
 *          tokens
 *  len     The size of the value for TOK_WORD and TOK_QUOTED_WORD tokens
 *
...
/*
 * Creates a new token using the full size of the value
 *
 * Parameters:
 *  type    The type of the token to create
 *  value   The pointer to the value for TOK_WORD and TOK_QUOTED_WORD
